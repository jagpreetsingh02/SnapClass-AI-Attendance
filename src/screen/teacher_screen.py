...
from src.database.db import check_teacher_username, create_teacher, teacher_login, get_teacher_subjects, get_attendance_for_teacher
import time
from src.components.dialog_create_subject import create_subject_dialog
...
def teacher_dashboard():
    ...
    with tab3:
        ...
        if st.button("Attendance record", type = type3, width = "stretch", icon = ":material/ar_on_you:"):
